...
--
-- Host: localhost    Database: hibernate_tutorial
-- ------------------------------------------------------
...
INSERT INTO `country` VALUES (1,'BANGLADESH'),(2,'INDIA'),(3,'NEPAL'),(4,'BHUTAN'),(5,'SRILANKA'),(6,'UK'),(7,'USA'),(8,'RASSIA');
...
INSERT INTO `department` VALUES (1,'SDD'),(2,'OSA'),(3,'OPA');
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_user_detail_id_fk` (`user_detail_id`),
  CONSTRAINT `user_user_detail_id_fk` FOREIGN KEY (`user_detail_id`) REFERENCES `user_detail` (`id`)
...
INSERT INTO `user` VALUES (2,'Deboraj','roy',NULL),(3,'supria','osman',6),(4,'abdul','hamid',7),(5,'MR','Y',8);
...
CREATE TABLE `user_detail` (
  ...
  PRIMARY KEY (`id`),
  KEY `userToCountry_idx` (`country_id`),
  CONSTRAINT `userToCountry` FOREIGN KEY (`country_id`) REFERENCES `country` (`country_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_detail` VALUES (5,'HEMENDRO NATH ROY','NANDITA','RUIT',1),(6,'FATHER ONE','MOTHER ONE','BRUR',2),(7,'FATHER TWO','FATHER TWO','NSTU',4),(8,'LAL MIA','BILKIS BANU','PSTU',5);
...
-- Dump completed on 2022-08-24 19:54:14
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
...
INSERT INTO ` authorities` VALUES ('deboraj','Donnor'),('priya','Client');
...
CREATE TABLE `blood_bank` (
  ...
  `user_detail_id` varchar(45) DEFAULT NULL,
...
INSERT INTO `blood_bank` VALUES (101,'A+','109','1'),(102,'A-','203','2'),(103,'B+','251','3'),(104,'B-','155','4');
...
CREATE TABLE `client` (
  ...
  KEY `user_user_detail_id_fk` (`user_detail_id`),
  CONSTRAINT `user_user_detail_id_fk` FOREIGN KEY (`user_detail_id`) REFERENCES `hibernate_tutorial`.`user_detail` (`id`)
...
INSERT INTO `client` VALUES (1,'1111','priya','A+','0178','dhaka','23',1);
...
INSERT INTO `users` VALUES ('deboraj','12345',1),('love','you',1),('priya','123456',1),('sovon','09876',1),('supriya','1111',1);
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2022-07-15 05:12:28',NULL),('diagnostics.include_raw','OFF','2022-07-15 05:12:28',NULL),('ps_thread_trx_info.max_length','65535','2022-07-15 05:12:28',NULL),('statement_performance_analyzer.limit','100','2022-07-15 05:12:28',NULL),('statement_performance_analyzer.view',NULL,'2022-07-15 05:12:28',NULL),('statement_truncate_len','64','2022-07-15 05:12:28',NULL);
...
-- Dump completed on 2022-08-24 19:54:16
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
...
CREATE TABLE `bloodinfo` (
  `idbloodinfo` int NOT NULL,
  `bloodgroup` varchar(45) NOT NULL,
  `quantity` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idbloodinfo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `bloodinfo` WRITE;
/*!40000 ALTER TABLE `bloodinfo` DISABLE KEYS */;
INSERT INTO `bloodinfo` VALUES (301,'A+','100'),(302,'A-','55'),(303,'B+','269'),(304,'B-','151'),(305,'AB+','51'),(306,'AB-','97'),(307,'O+','33'),(308,'O-','17');
/*!40000 ALTER TABLE `bloodinfo` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_contact` (
  ...
  CONSTRAINT `user_contact_user_detail_id_fk` FOREIGN KEY (`id`) REFERENCES `hibernate_tutorial`.`user_detail` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `userdata` WRITE;
/*!40000 ALTER TABLE `userdata` DISABLE KEYS */;
INSERT INTO `userdata` VALUES (101,'Deboraj','deboraj@email.com',1019876781987,'19-May-1998','B+','01700000001','Rangpur','Donner','Male','12345'),(103,'supriya','supriya@email.com',1030981092819,'20-May-1999','A+','01600000001','Bikrampur','Client','Female','1234');
/*!40000 ALTER TABLE `userdata` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `users` WRITE;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` VALUES ('deboraj@email.com','12345',1),('supriya@emai.com','1234',1);
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
